...
# ---------------------------------------------------------
# 3. STATIC & DYNAMIC QUESTION BANK (53 Total)
# ---------------------------------------------------------
# The first 3 questions are fixed to establish the MACRO vibe. 
static_qs = [
...
# The next 50 are dynamic, funneled opaque questions.
raw_qs = [
...
# ---------------------------------------------------------
# Opposites guarantee extreme funneling. If you pick hot, cold loses points.
opposites = {
    "hot": "cold", "cold": "hot", 
