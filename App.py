...
def set_bg(color, text_color):
    ...
    h1, h2, h3, h4, p, span, label, div, li {{ color: {text_color} !important; font-family: 'Arial', sans-serif; }}
    .stButton > button {{
...
raw_dests = [
    ...
    "Mexico City|mild,city,foodie,culture,party|#B22222|mexico city zocalo vibrant culture|Dine at a top 10 restaurant in the world|Eat endless Al Pastor street tacos|High-end Mezcal tasting in a slick speakeasy|Drink Micheladas in a loud Cantina|Ride colorful boats in Xochimilco|Browse art in the Frida Kahlo Museum|Climb the massive ancient Pyramids of the Sun and Moon|Watch a wild high-flying Lucha Libre wrestling match|Party until dawn in the trendy Roma Norte district|Take a hot air balloon over the Teotihuacan ruins|Eat exotic insects like chapulines|Explore the massive Chapultepec Castle",
    "Tulum (Mexico)|hot,beach,party,culture,relax|#20B2AA|tulum mexico beach cenote ancient ruins jungle|Eat gourmet Maya-fusion dining in the jungle|Eat fresh fish tacos barefoot on the beach|Drink Matcha lattes at a treehouse|Drink Mezcal at a massive jungle techno rave|Float down a crystal clear underground Cenote|Do yoga on the beach at sunrise|Explore the ancient Mayan ruins perched on the cliff edge|Scuba dive in the dark underwater cave systems|Swim with giant sea turtles in Akumal|Kitesurf on the breezy Caribbean ocean|Take a mud bath in a Mayan sweat lodge|Rent a bicycle to ride down the trendy beach road",
    ...
    "Rio de Janeiro (Brazil)|hot,beach,party,culture,city|#32CD32|rio de janeiro christ the redeemer copacabana|Endless premium meats at a luxury Churrascaria|Eat Pão de Queijo on the street|Drink Caipirinhas on Copacabana beach|Drink cold chopp in a lively boteco|Take the cable car up Sugarloaf Mountain|Buy a tiny bikini and play footvolley|Take a helicopter around the massive Christ the Redeemer statue|Dance Samba until dawn at the massive Carnival parade|Hang glide off a mountain and land on the beach|Explore the vibrant Favela communities|Hike through the Tijuca urban rainforest|Attend a massive soccer game at Maracanã Stadium",
    ...
    "Tromso (Norway)|cold,nature,adventure,mountains|#000033|tromso norway snowy fjords aurora|Arctic fine dining with king crab|Eat dried fish like a true Viking|Taste Aquavit in the worlds northernmost brewery|Drink hot toddies on a silent whale watching boat|Sleep in a glass igloo under the Northern Lights|Warm up by a fire in a cozy candlelit cafe|Chase the Northern Lights in the arctic wilderness|Whale watch for massive Orcas in the fjords|Dog sled across the frozen tundra with Siberian Huskies|Snowshoe through silent snowy valleys|Feed reindeer with indigenous Sami people|Ride the cable car for sunset views",
    "Svalbard (Norway)|cold,nature,adventure,mountains|#E0FFFF|svalbard polar bears arctic ice|Gourmet dining at the edge of the world|Eat freeze-dried expedition meals in a tent|Champagne tasting in a coal miners cellar|Drink pure melted glacier water|Mail a letter from the northernmost post office|Spot arctic foxes playing in the snow|Armed expedition to safely spot wild Polar Bears|Explore the Global Seed Vault|Snowmobile to an abandoned Soviet ghost town|Ice cave inside a massive glacier|Kayak in freezing waters past walruses|Experience 24 hours of total darkness or sunlight",
    "Santorini (Greece)|hot,beach,relax,luxury,romance|#00008B|santorini white houses blue domes sunset|Private clifftop dining with fresh lobster|Eat a massive Gyros from a bustling local taverna|Wine tasting in a volcanic cave vineyard|Drink cocktails on a luxury catamaran at sunset|Do the flying Dress photoshoot on the white roofs|Wander the white cobblestone streets of Oia|Sail a yacht to the volcanic hot springs|Scuba dive in the deep caldera|Take a helicopter ride over the Greek Islands|Rent ATVs to explore hidden black sand beaches|Explore the ancient ruins of Akrotiri|Jump off the cliffs at Amoudi Bay",
    ...
    "Luxor (Egypt)|hot,culture,adventure|#DAA520|luxor egypt ancient temples desert|Gourmet Egyptian dining|Eat stuffed pigeon|Drink strong mint tea|Drink fresh sugarcane juice|Walk the Avenue of Sphinxes|Browse the local markets|Take a spectacular Hot Air Balloon ride at sunrise over the temples|Explore the massive Karnak Temple complex|Go deep into the tombs in the Valley of the Kings|Sail the Nile on a traditional boat|Explore the Temple of Hatshepsut|Ride a donkey through the local villages",
    ...
    "Queenstown (New Zealand)|mild,cold,mountains,adventure,party|#556B2F|queenstown new zealand mountains lake extreme|Fine dining accessible only by a steep gondola|Eat the world-famous massive Fergburger|Taste world-class Pinot Noir in Central Otago|Drink shots in an ice bar made of glaciers|Ride the Luge go-karts down the mountain|Soak in the private cliffside Onsen Hot Pools|Bungee jump off the Kawarau Bridge where the sport was invented|Jet boat at 90kmh through narrow shallow river canyons|Skydive over the breathtaking Remarkables mountain range|Helicopter ski on untouched alpine powder|Hike the brutal rewarding Ben Lomond track|Paraglide off a mountain over the town",
...
animal_map = {
    ...
    "Zhangjiajie (China)": ["Macaques", "Giant Salamanders"],
    "Chengdu (China)": ["Giant Pandas", "Red Pandas"],
    "Tokyo (Japan)": ["Shiba Inus", "Koi Fish", "Ueno Zoo Pandas"],
    "Kyoto (Japan)": ["Sika Deer", "Japanese Macaques"],
    "Osaka (Japan)": ["Whale Sharks (Aquarium)", "Sea Turtles"],
    "Hokkaido (Japan)": ["Ezo Red Foxes", "Snow Monkeys", "Brown Bears"],
    "Seoul (South Korea)": ["Magpies", "Raccoon Dogs"],
    "Jeju Island (South Korea)": ["Roe Deer", "Dolphins", "Jeju Horses"],
    "Bangkok (Thailand)": ["Monitor Lizards", "Stray Cats"],
    "Chiang Mai (Thailand)": ["Asian Elephants", "Gibbons", "Water Buffalo"],
    "Phuket (Thailand)": ["Sea Turtles", "Macaques", "Whale Sharks"],
    "Bali (Indonesia)": ["Long-tailed Macaques", "Sea Turtles", "Manta Rays"],
    "Komodo Island (Indonesia)": ["Komodo Dragons", "Manta Rays", "Flying Foxes"],
    "Raja Ampat (Indonesia)": ["Birds of Paradise", "Manta Rays", "Wobbegong Sharks"],
    "Singapore": ["Smooth-coated Otters", "Hornbills", "Macaques"],
    "Hanoi (Vietnam)": ["Hoan Kiem Turtles", "Water Buffalo"],
    "Ha Long Bay (Vietnam)": ["Cat Ba Langurs", "Sea Hawks"],
    "Palawan (Philippines)": ["Sea Turtles", "Palawan Peacock Pheasants", "Dugongs"],
    "Siargao (Philippines)": ["Tarsiers (nearby)", "Sea Turtles", "Dolphins"],
    "Taipei (Taiwan)": ["Formosan Rock Macaques", "Blue Magpies"],
    ...
    "Miami (USA)": ["Alligators", "Manatees", "Dolphins"],
    "Oahu (Hawaii)": ["Green Sea Turtles", "Monk Seals", "Humpback Whales"],
    "Kauai (Hawaii)": ["Wild Chickens", "Nene Geese", "Sea Turtles"],
    "Yellowstone (USA)": ["Bison", "Grizzly Bears", "Gray Wolves", "Elk"],
    "Banff (Canada)": ["Grizzly Bears", "Moose", "Elk", "Bighorn Sheep"],
    "Whistler (Canada)": ["Black Bears", "Marmots", "Bald Eagles"],
    "Mexico City": ["Axolotls", "Xoloitzcuintli Dogs"],
    "Tulum (Mexico)": ["Sea Turtles", "Spider Monkeys", "Iguanas"],
    "Oaxaca (Mexico)": ["Hummingbirds", "Ocelots (wild)"],
    "Costa Rica": ["Three-toed Sloths", "Howler Monkeys", "Toucans", "Red-eyed Tree Frogs"],
    "Belize": ["Nurse Sharks", "Howler Monkeys", "Jaguars"],
    "Havana (Cuba)": ["Cuban Trogon", "Hutia"],
    "Rio de Janeiro (Brazil)": ["Marmosets", "Toucans", "Capybaras"],
    "Amazon Rainforest (Brazil)": ["Pink River Dolphins", "Jaguars", "Sloths", "Macaws"],
    "Patagonia (Argentina)": ["Guanacos", "Pumas", "Magellanic Penguins", "Andean Condors"],
    "Atacama Desert (Chile)": ["Flamingos", "Vicuñas", "Llamas"],
    "Salar de Uyuni (Bolivia)": ["Andean Flamingos", "Alpacas", "Llamas"],
    "Galapagos Islands (Ecuador)": ["Giant Tortoises", "Marine Iguanas", "Blue-footed Boobies", "Sea Lions"],
    "Machu Picchu (Peru)": ["Llamas", "Alpacas", "Andean Condors"],
    ...
    "Cinque Terre (Italy)": ["Dolphins", "Wild Boars"],
    ...
    "Amsterdam (Netherlands)": ["Herons", "Swans"],
    "Iceland": ["Icelandic Horses", "Puffins", "Arctic Foxes", "Whales"],
    "Tromso (Norway)": ["Reindeer", "Orcas", "Humpback Whales", "Husky Dogs"],
    "Svalbard (Norway)": ["Polar Bears", "Arctic Foxes", "Walruses", "Svalbard Reindeer"],
    "Santorini (Greece)": ["Donkeys", "Stray Cats"],
    "Mykonos (Greece)": ["Pelicans", "Stray Cats"],
    "Dubrovnik (Croatia)": ["Street Cats", "Peacocks (Lokrum Island)"],
    "Plitvice Lakes (Croatia)": ["Brown Bears", "Wolves", "Lynx"],
    "Prague (Czechia)": ["Swans", "Peacocks"],
    ...
    "Serengeti (Tanzania)": ["Wildebeest", "Cheetahs", "Lions", "Giraffes", "Zebras"],
    "Zanzibar (Tanzania)": ["Red Colobus Monkeys", "Aldabra Giant Tortoises", "Dolphins"],
    "Marrakesh (Morocco)": ["Camels", "Street Cats", "Storks"],
    "Cairo (Egypt)": ["Camels", "Arabian Horses", "Desert Foxes"],
    "Luxor (Egypt)": ["Donkeys", "Camels", "Egrets"],
    ...
    "Milford Sound (New Zealand)": ["Bottlenose Dolphins", "Fur Seals", "Fiordland Crested Penguins"],
    "Bora Bora (French Polynesia)": ["Blacktip Reef Sharks", "Stingrays", "Sea Turtles"],
    "Sydney (Australia)": ["Kangaroos (Zoo)", "Koalas (Zoo)", "Grey Nurse Sharks"],
    "Melbourne (Australia)": ["Little Penguins", "Kangaroos (outskirts)"],
    "Fiji": ["Sea Turtles", "Reef Sharks", "Fruit Bats"],
    "Samoa": ["Sea Turtles", "Flying Foxes"],
    "Rotorua (New Zealand)": ["Kiwi Birds", "Black Swans"]
}
...
if st.session_state.stage == 'welcome':
    ...
    <p style='font-size: 22px;'>4. Finally, view your personalized travel guide.</p>
    </div>
    ...
    safe_image(dest_data["p"], seed=101)
    ...
    dest_data = dests[best_dest]
    set_bg(dest_data["c"], "#FFFFFF")
    if "cold" in dest_data["t"]: st.snow()
    else: st.balloons()
    ...
    st.markdown("<br><h3>Your Ultimate Hand-Picked Itinerary:</h3>", unsafe_allow_html=True)
    ...
    st.markdown(f"<h1 style='text-align: center; font-size: 50px;'>🐾 Wildlife & More in {best_dest}</h1><br>", unsafe_allow_html=True)

    colA, colB = st.columns(2)
    with colA:
        st.markdown("<div style='background: rgba(0,0,0,0.5); padding: 25px; border-radius: 15px;'>", unsafe_allow_html=True)
        ...
        for a in unpicked:
            st.markdown(f"<li style='font-size: 20px; margin-bottom: 10px;'>{a}</li>", unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)

    with colB:
        st.markdown("<div style='background: rgba(0,0,0,0.5); padding: 25px; border-radius: 15px;'>", unsafe_allow_html=True)
        st.markdown("<h3>Animals You Might Spot</h3>", unsafe_allow_html=True)
        animals = animal_map.get(best_dest, ["Native wildlife, local birds, and friendly street animals"])
        for animal in animals:
            st.markdown(f"<li style='font-size: 22px; margin-bottom: 15px;'>📸 <b>{animal}</b></li>", unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    set_bg("#000000", "#FFFFFF")
    st.markdown("<div class='giant-emoji' style='margin-top: 50px; font-size: 100px; text-align: center;'>❤️</div>", unsafe_allow_html=True)
